...
import { playBuilderSocialRenderOptions, renderPlayBuilderDiagramSvg, renderPlayBuilderSocialSvg } from '$lib/server/play-builder-social-image';
...
export const GET: RequestHandler = async ({ params, url }) => {
	...
	const image = new Resvg(svg, playBuilderSocialRenderOptions()).render().asPng();
