...
<section class="space-y-6">
	...
	<form method="POST" use:namedActionForm={'save'} class="space-y-6 border border-stone-300 bg-white p-6 shadow-sm">
			...
			<label class="flex items-center gap-3 border border-stone-300 px-3 py-2 md:col-span-2">
				...
				<span>
					...
					<span class="text-xs text-stone-600"
						>Hidden case plays remain available to administrators but are excluded from search, playlists, direct URLs, and the sitemap.</span
					>
				</span>
			</label>
			<div class="space-y-1 md:col-span-2">
	...
	<form method="POST" use:namedActionForm={'delete'} class="border border-red-300 bg-red-50 p-4">
