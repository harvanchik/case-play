<svelte:head>
	<title>Cookie Policy | caseplay.org</title>
	<meta name="description" content="How caseplay.org uses cookies, browser storage, and advertising technology." />
</svelte:head>
...
<main class="min-h-screen bg-stone-100 px-4 py-10 text-stone-800">
	<article class="mx-auto max-w-3xl border-2 border-stone-900 bg-white p-6 sm:p-10">
		...
		<p class="mt-2 text-sm text-stone-500">Last updated July 16, 2026</p>

		<h2 class="mt-7 text-xl font-bold">Essential storage</h2>
		<p class="mt-2 leading-7">
			Caseplay uses local storage to remember your privacy choice, session storage for short-lived play-builder editing information, and a protected session cookie for authorized administrators. These support requested features, security, and site operation.
		</p>
		...
		<p class="mt-2 leading-7">Use <a class="font-semibold underline" href="/privacy">Privacy</a> to review or change your selection. A change reloads the page so future ad requests use the new setting. You can also clear existing site data in your browser.</p>
	</article>
</main>
